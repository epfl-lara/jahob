...
| WhiteSpace
    { token lexbuf }
| LineTerminator
    { Lexing.new_line lexbuf; next_line lexbuf; token lexbuf }
| "/*"
    { begin_comment lexbuf; comment lexbuf; token lexbuf }
| EndOfLineComment
    { eol_comment lexbuf; Lexing.new_line lexbuf; next_line lexbuf; token lexbuf }
| Identifier
    { identifier lexbuf }
| Literal
    { literal lexbuf }
...
and comment = parse
  "*/" { end_comment lexbuf }
| LineTerminator  { continue_comment lexbuf; Lexing.new_line lexbuf; next_line lexbuf; comment lexbuf }
