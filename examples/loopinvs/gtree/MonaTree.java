/* A global tree with sorting.

PLUS:
  given loopinvs, all automated by z3 and mona
  
MINUS:
  very, very slow (say, 16minutes without parallelization), as MONA is slow
  a number of noteThat's
...
public class Tree
{
   ...
   */
   ...
   // swap takes almost 3 hrs to verify with a 60s timeout in vanilla
