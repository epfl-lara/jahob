...
public class BH 
{
  ...
  public static final void main(String args[])
  {
    ...
    int tnow = 0;
    int i = 0;
    while ((tnow < TSTOP + DTIME/10) && (i < nsteps)) {
      root.stepSystem(i++);
      tnow += DTIME;
    }
    ...
    if (printMsgs) {
      ...
      System.out.println("BH Total Time " + (end1 - start0)/1000.0);
    }
   ...
   **/
  static final int myRand(int seed)
  {
    int t = 16807*seed + 1;
    
    seed = t - (2147483647 * (t / 2147483647));
    return seed;
  }
   ...
   **/
  static final int xRand(int xl, int xh, int r)
  {
    int res = xl + (xh-xl)*r/2147483647;
    return res;
  }
