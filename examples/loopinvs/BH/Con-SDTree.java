class Node {
    ...
    Node next;
    Node subp[] = null;
    Lock node_mutex = new Lock();

    // Tree properties
    static Node nodes;
    static Node root;
    static Lock tree_mutex = new Lock();
