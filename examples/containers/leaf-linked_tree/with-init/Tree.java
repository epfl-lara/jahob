 ...
 *
 * Note: In this version, class verifies in the initial state but leaf related methods do not verify.
 */
...
class Tree
{
   ...
   /*: public static specvar nodes :: objset;
	...
	invariant LeftNotRight: "ALL x. x : nodes --> x..Node.left ~= x..Node.right";
       ...
       invariant ParentFieldConstraint: "ALL x y. x:nodes & Node.parent x = y -->((x = root --> y = null) & (x ~= root -->
