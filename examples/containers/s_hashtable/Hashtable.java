class Hashtable {
    ...
    */
	...
	Object foo = AssocList.lookup(key, table[hash]);
	//: assert "Object.alloc = (old Object.alloc)"
        if (foo != null) size = size + 1;
    ...
    */
    {
	int hash = compute_hash (key);
	if (AssocList.lookup(key, table[hash]) != null) size = size - 1;
