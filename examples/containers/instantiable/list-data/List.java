/* Instantiable list with data fields.  Also works as stack.
    
    PLUS:
      -instantiable
      -data field indirection
      -member, addFirst, popFirst, remove operations
      -interesting test case
    MINUS:
      -complex loop invariant
...
class List {
   ...
   */
    ...
    */
    ...
    public void addFirst(Object o1)
    /*: modifies content
    ...
    */
    ...
    // note, the final frame condition only goes through with SMT provers, not resolution-based ones
    public static void test() 
    //: modifies "new..content" ensures "True"
    {
        List l = new List();
        Cell o1 = new Cell();
        Cell o2 = new Cell();
