...
class Hashtable {
    ...
    */
	...
	//: note HiddenLemma: "null \<in> hidden \<longrightarrow> table.[hc] \<in> hidden" from NodeHidden1, HCProps, ThisProps;
	...
	/*: noteThat FNotRefByNext: "\<forall> x. x..next \<noteq> f"
	    from FirstInjInv, ThisProps, FNonNull, HCProps, FProps; */
