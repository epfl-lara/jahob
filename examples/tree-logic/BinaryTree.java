public final class Node {
   public /*: claimedby BinaryTree */ int key;
   public /*: claimedby BinaryTree */ Node left;
   public /*: claimedby BinaryTree */ Node right;
    public /*: claimedby Tree */ Node par;
}
...
public class BinaryTree {
   ...
   /*:
     ...
     invariant "ptree par [Node.left, Node.right]";
     ...
     */
   {
	...
	noteThat "(EX x. x ~= null & x : nodes root)";
      */
      ...
      Node node = root;
      boolean wentLeft = false;
      while /*: inv "ptree par [Node.left, Node.right] &
	      (wentLeft & parent ~= null --> parent..Node.left = node & key < parent..Node.key) &
	      (~wentLeft & parent ~= null --> parent..Node.right = node & ~(key < parent..Node.key)) &
	      parent : nodes root & 
	      node : nodes root &
	 ...
	 parent.right = newSubroot;
      ...
      //: assert "ptree par [Node.left, Node.right]";
