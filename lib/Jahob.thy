...
constdefs
  ...
  "cardinality s == int (card s)"  (* just change the result type *)

declare cardinality_def [simp]
...
declare int_distrib [simp]
declare pos_mod_sign [simp]
declare pos_mod_bound [simp]
declare zmult_assoc [simp]
